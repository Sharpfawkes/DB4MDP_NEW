...
import csv
with open('references.csv', 'w', newline='\n') as file:
    writer = csv.writer(file)
    for val in referencesdict.values():
        # the writer is expecting a list/tuple not a string. It will typecast the string to a list
        # and write each character separated by commas in the file unless the string is placed within a list as
        # below.
        # data = key + " " + val
        writer.writerow([val])
    # for val in referencesdict.values():
